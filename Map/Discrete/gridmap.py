...
class grid_map:
    def __init__(self,
        ...
        if map_file is None:
            ...
            # self.map_set_obs(is_fixed=False, obs=[])  # set obstacles

            obs1 = [[1, 15], [2, 15], [3, 15], [4, 15], [5, 15],
            ...
            obs2 = [[15, 5], [15, 6], [15, 7], [15, 8], [15, 9], [15, 10], [15, 11],
                    [15, 12], [15, 13], [15, 14], [15, 15], [15, 16], [15, 17], [15, 18]]
            obs3 = [[6,15],[7,15],[8,15],[9,15],[10,15], [11,15],[12,15],[13,15],[14,15],
                    [14,14],[14,13],[14,12],[14,11],[14,10],[14,9],[14,8],[14,7],[14,6],
                    [14,5],[14,4],[14,3],[14,2], [6,2], [7,2],[8,2],[9,2],[10,2],[11,2],
                    [12,2],[13,2]]

            self.map_set_obs(is_fixed=True, obs=obs3)  # set obstacles
